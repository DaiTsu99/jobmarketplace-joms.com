...
<script>
    $('#filter-form').on('submit', function(e){
        e.preventDefault();
        let text = $('#searchTalent').val();
        $('#searchTalentHidden').val(text);
        this.submit();
    });
