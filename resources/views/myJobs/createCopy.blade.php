<x-layout>
    ...
    <x-myJobs.copy-form/>
    {{--TODO Create New Post based on previous job post--}}
                        ...
                        <form
                            ...
                            <div class="mb-6">
                                ...
                                <div class="italic text-sm ml-4 mb-2">
                                    Enter the sector(s) separated by comma, do follow the spelling, and you may also add a new tag if it's not available
                                </div>
                                <x-panel>
                                <input class="border border-gray-400 p-2 w-full rounded"
                                type="text"
